...
3.  **⚙️ Build Settings**: (Auto-configured by `vercel.json`)
    - Build Command: `npm run build:web` 🏗️
...
You can customize the application's behavior using a `.env` file in the root directory: ⚙️
